...
NOTE: You must enable the hardened C++ standard library to take advantage of this protection. In clang/libc++, that means setting `CLANG_CXX_STANDARD_LIBRARY_HARDENING = extensive`.
